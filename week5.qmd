...
## ![Correlation and linear regression. Image from Lenny's Newsletter.](img/wk5-b-5.png)
...
![Open a new RScript.](img/wk3-c-1.png)
...
![Find the `Plots` tab.](img/wk3-c-1.png)
...
![See the bottom right of the screen.](img/wk3-c-1.png)
