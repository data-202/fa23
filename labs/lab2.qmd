...
You should submit your final output on Canvas [here](https://canvas.howard.edu/courses/40683).

------------------------------------------------------------------------

# Part 0: Pre-lab tasks

-   Create a new project called `stats-pt3`
...
## Task 0.5: Packages and libraries
...
-   Locate a data sets in the `critstats` package or in `gss_cat`
...
You can also leave a comment on the [Lab Discussion Board](https://canvas.howard.edu/courses/40683/discussion_topics/368088) or in our course Slack channel.
