...
In paper 2, you should create two dichotomous variables to conduct bivariate analyses, such as examining differences in proportions.

Please refer to the [Week 7](/week7.html) lecture for support with bivariate analyses.

Please refer to the [Week 8](/week8.html) lecture for support with hypothesis testing with crosstab.
